...
import { fetch as _fetch } from '../platform';
/**
...
export interface API {
     ...
     */
    put(service: Service, files: Iterable<Filelike>, options?: PutOptions): Promise<CIDString>;
    /**
     ...
     */
    putCar(service: Service, car: CarReader, options?: PutCarOptions): Promise<CIDString>;
    /**
...
export declare type PutOptions = RequestOptions & {
    /**
...
export declare type PutCarOptions = RequestOptions & {
    /**
     * Human readable name for this upload, for use in file listings.
     */
    name?: string;
...
export declare type ListOptions = RequestOptions & {
    /**
